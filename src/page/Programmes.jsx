    ...
    <section className='mt-5'>
        <div>
            ...
            <div className='px mb-10 min-h-[400px] md:py-10 max-h-screen flex max-sm:flex-col gap-10 mt-5 md:mt-10'>
                <img src={renovate} alt=""  className=' hidden md:flex'/>
                <div className='grid  gap-2'>
                    ...
                    <Link to='/donate' className='w-full'><button type="button" className='button'>Donate</button></Link>
                </div>
            ...
            <div className='px pt-20 md:mt-10 min-h-[470px]'>
                <div className='bg-programJoin rounded-[16px] bg-cover bg-no-repeat h-[300px] md:h-[500px] flex flex-col items-center justify-center px-5 md:px-20'>
                    ...
                    <p className='text-whites-200'>Make a difference today! Your time and skills can bring hope and transform communities. 
                        Join us in empowering others and creating lasting change!
                    </p>
                </div>
                <div className='w-9/12 gap-5 md:gap-10 mx-auto my-10 flex max-sm:flex-col justify-between'>
                    ...
                    <Link to='/donate' className='w-full'><button type="button" className='button w-full md:w-5/12'>Donate</button></Link>
                </div>
            </div>
            <Footer/>
        </div>
